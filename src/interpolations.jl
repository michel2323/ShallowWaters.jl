...
function Ix!(ux::Matrix{T},u::Matrix{T}) where {T<:Real}
    m, n = size(ux)
...
function Iy!(uy::Matrix{T},u::Matrix{T}) where {T<:Real}
    m,n = size(uy)
...
function Ixy!(uxy::Array{T,2},u::Array{T,2}) where {T<:Real}
    m,n = size(uxy)
...
function Ix(u::Array{T,2}) where {T<:Real}
...
function Iy(u::Array{T,2}) where {T<:Real}
